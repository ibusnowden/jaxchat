#!/usr/bin/env bash
#SBATCH --job-name=jaxchat-0p5b-smokebase
...
#SBATCH --output=/project/inniang/jaxchat/slurm-0p5b-smokebase-%A.out
#SBATCH --error=/project/inniang/jaxchat/slurm-0p5b-smokebase-%A.err
#SBATCH --export=ALL
#SBATCH --exclusive
...
"${PROJECT_DIR}/.venv/bin/python" "${PROJECT_DIR}/dev/smoke_base_0p5b.py"
