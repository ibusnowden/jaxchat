#!/usr/bin/env bash
#SBATCH --job-name=jaxchat-0p5b-smoke
...
#SBATCH --output=/project/inniang/jaxchat/slurm-0p5b-smoke-%A.out
#SBATCH --error=/project/inniang/jaxchat/slurm-0p5b-smoke-%A.err
#SBATCH --export=ALL
#SBATCH --exclusive
...
"${PROJECT_DIR}/.venv/bin/python" "${PROJECT_DIR}/dev/smoke_chat_0p5b.py"
